...
{
    /// <summary>
    /// <strong>Gets an analytics report for one or more games.</strong>
    /// </summary>
    public class GetGameAnalytics : IStandardEndpoint, ICacheRequest
    {
        private static HttpMethod method = HttpMethod.Get;
        private static string EndpointURL = "https://api.twitch.tv/helix/analytics/games";
        /// <summary>
        /// Requiered Scopes to use this endpoint.
        /// </summary>
        public static string RequieredScopes { get; } = "analytics:read:games";
        /// <summary>
        ...
        /// <summary>
        /// <strong>Gets an analytics report for one or more games.</strong>
        /// <para>Scope: <em>analytics:read:games</em></para>
        /// <para>TokenType: <em>User Access Token</em></para>
        /// <see href="https://dev.twitch.tv/docs/api/reference#get-game-analytics">Twitch Docs (Error Handling)</see> 
        /// </summary>
        ...
        /// <returns>An object of GetGameAnalytics, containing response variables from this request. (only if item was found in cache, or request was successful)</returns>
        public static GetGameAnalytics Go(Login.Credentials credentials, QueryParams requestQueryParameter, out bool isSuccess, out int httpStatuscode, bool skipCache = false)
        {
            ...
            {               //no? -> Read Cache!
                ...
                if (isCachedObjValid && cachedObject != null) //if cache is still valid then return cached object
                {
                    ...
                    isSuccess = true;
                    return (GetGameAnalytics)cachedObject;
                }
            }
            ...
            var finalobject = JsonConvert.DeserializeObject<GetGameAnalytics>(raw.data[0].ToString()); //deserialize into an object of GetExtensionAnalytics
